...
describe('DocsSearchBar', function () {
  ...
  describe('constructor', function () {
    ...
    it('should call checkArguments', function () {
      // Given
      var options = defaultOptions; // When

      new _DocsSearchBar.default(options); // Then
    ...
    it('should pass main options as instance properties', function () {
      ...
      var actual = new _DocsSearchBar.default(options); // Then
    ...
    it('should pass the input element as an instance property', function () {
      ...
      _DocsSearchBar.default.getInputFromSelector.returns((0, _zepto.default)('<span>foo</span>')); // When
    ...
    it('should instantiate autocomplete.js', function () {
      ...
      _DocsSearchBar.default.getInputFromSelector.returns($input); // When
  ...
  describe('checkArguments', function () {
    ...
    it('should throw an error if no hostUrl defined', function () {
      // Given
      var options = defaultOptions;
      delete options.hostUrl; // When

      expect(function () {
        checkArguments(options);
      }).toThrow(/^Usage:/);
    });
    it('should throw an error if no inputSelector defined', function () {
      // Given
      var options = defaultOptions;
      delete options.inputSelector; // When
    ...
    it('should throw an error if no selector matches', function () {
      ...
      _sinon.default.stub(_DocsSearchBar.default, 'getInputFromSelector').returns(false); // When
  ...
  describe('getInputFromSelector', function () {
    ...
    it('should return null if no element matches the selector', function () {
      // Given
      var selector = '.i-do-not-exist > at #all'; // When

      var actual = getInputFromSelector(selector); // Then

      expect(actual).toEqual(null);
    });
    it('should return null if the matched element is not an input', function () {
      // Given
      var selector = '.i-am-a-span'; // When
  ...
  describe('getAutocompleteSource', function () {
    ...
    it('returns a function', function () {
      // Given
      var actual = docsSearchBar.getAutocompleteSource(); // When
      // Then
  ...
  describe('handleSelected', function () {
    ...
    it('should prevent all clicks on links if a custom handleSelected is specified', function () {
      ...
      suggestions.append(testLink); // Simulating a click on the link
    ...
    describe('default handleSelected', function () {
      it('enterKey: should change the page', function () {
        ...
        new _DocsSearchBar.default(options).handleSelected(mockInput, undefined, // Event
  ...
  describe('formatHits', function () {
    it('should not mutate the input', function () {
      ...
      var actual = _DocsSearchBar.default.formatHits(input); // Then
    ...
    it('should concatenate lvl2+ for title if more', function () {
      ...
      var separator = '<span class="aa-suggestion-title-separator" aria-hidden="true"> › </span>'; // Then
  ...
  describe('formatUrl', function () {
    it('concatenates url and anchor', function () {
      ...
      var actual = _DocsSearchBar.default.formatURL(input); // Then
    ...
    it('emits a warning if no anchor nor url', function () {
      ...
      _DocsSearchBar.default.formatURL(input); // Then
  ...
  describe('getSuggestionTemplate', function () {
    it('should return a function', function () {
      // Given
      // When
      var actual = _DocsSearchBar.default.getSuggestionTemplate(); // Then
