...
const setupAppPlugins_1 = require("./setupAppPlugins");
const setupAppTheme_1 = require("./setupAppTheme");
/**
 * Create vuepress app
 */
const createBaseApp = (config, isBuild = false) => {
    ...
    (0, setupAppTheme_1.setupAppTheme)(app, config);
    (0, setupAppPlugins_1.setupAppPlugins)(app);
    return app;
};
