...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220714/image.4mlup2f5a080.webp)

## 菜品的批量删除

前端发来的请求:

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.70vsudwh7eg0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4ovdplwu0880.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.59qrcjycj2w0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.3xm6qfw5i7a0.webp)

但是这样我们再点击添加菜品会发现，右边只展示菜品的价格并没有展示菜品对应的名称：

**已选菜品中的菜品并没有展示对应的菜品名；**

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.6jfi34l3wzo0.webp)

 修改后的运行情况展示：

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.5hhiemeuiu40.webp)

修改具体的前端代码：把backend/combo/add.html中的335行修改为下面的代码；

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2awgkjbwp3b4.webp)

 因为这里的item是代表dish对象，dish实体类是使用name作为菜品名称的；

修改完成后，点击保存，我们发现前端发出一个put请求：

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.7guc6xuids40.webp)

 携带的参数为：

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.3pwwuihfci00.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4b3bhpf84d40.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2lkv3fqm6s00.webp)

## 后台按条件查看和展示客户订单

点击订单明细，前端会发下面的请求：携带的数据是分页使查询用的；

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4q5gms8wmww0.webp)

先写个controller看能不能接收到前端传过来的参数：**发现只要参数和前端传过来的参数名对应就可以拿到参数的**

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.6qez9emkw6s0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2dgx1psnb4e8.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.3sf092gzvk60.webp)

测试效果：

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.48iyk4xfsy60.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4wcvkecm2zk0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.5j69hlb9mvw0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4t5vcofr2420.webp)

**其实这里还没有完善！！！下面继续完善代码；**

通过order.html这个页面我们可以发现：前端还需要下面这些数据；所以我们后端要传给它。。。

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2qvajx45xqk0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2q6rx6wrefu0.webp)

+ **点击去支付，然后点击去查看订单：**

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4tnhur36c880.webp)

## 移动端的再来一单功能

**由于这里没有写后台的确认订单功能，所以这里通过数据库修改订单状态来完成测试！**

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.2jc4frrzf080.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.3m00dj9tmes0.webp)

+ 点击再来一单

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.40l7tsznnn60.webp)

并且购物车表中也有数据：

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.726dhlxuxos0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.3wg8ouy1h8y0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.1cgzu1p480hs.webp)

## 删除地址

前端点击删除地址：然后发送删除请求到后端

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.7cqu84vwpow0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.1q0zdzdz9ctc.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.e884zpstk6o.webp)

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.4916bv7pdda0.webp)
...
![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.5k9qwxvxiro0.webp)

## 移动端登陆退出功能

![image](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting1@master/20220715/image.77tlrb1jkb00.webp)
