...
module.exports = {
  ...
  themeConfig: {
    ...
    //首页大图
    bodyBgImg: 'https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/20220629/BingWallpaper(3).1jn61qrcu8f4.webp',  // 你的图片路径(必须位于 public 下)，可以是 URL
    ...
    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/20220627/mmexport1656324824543.124zxwkqyzlc.webp',
      name: 'xustudyxu',
      slogan: '一起学习编程!',
    },
    footer: {
