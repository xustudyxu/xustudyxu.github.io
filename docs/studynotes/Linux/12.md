...
![1631695213682](./images/12/01.png)

![1631695223928](./images/12/02.png)
...
![1631700431726](./images/12/03.png)
...
![1631723885527](./images/12/04.png)
...
![1631786043851](./images/12/05.png)
...
![1631788926924](./images/12/06.png)

### 12.5.3 service 管理指令案例
...
![1631798539866](./images/12/08.png)

### 12.5.6 CentOS7后运行级别说明
...
![1631806147056](./images/12/09.png)

### 12.5.13 firewall 指令

1. <font color=#DC4040 size=4 face="黑体">打开端口:firewall-cmd --permanent --add-port=端口号/协议(查看协议指令 :netstat -anp | more)</font>
2. <font color=#DC4040 size=4 face="黑体">关闭端口:firewall-cmd --permanent --add-port=端口号/协议号</font>
...
![1631807703518](./images/12/10.png)
...
![1631810755158](./images/12/11.png)

![1631810771119](./images/12/12.png)
