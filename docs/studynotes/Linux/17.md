...
![01](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/01.png)
...
![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/02.png)

![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/03.png)

### 备份Ubuntu 默认的源地址

<font color=#DC4040 size=4 face="黑体">sudo cp /etc/apt/sources.list /etc/apt/sources.list.backup</font>

![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/04.png)
...
![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/05.png)

复制镜像网站的地址，拷贝到sources.list文件

![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/06.png)

### 更新源

更新源地址:**sudo apt-get update** 

![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/07.png)
...
![08](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/08.png)
...
![09](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/Linux/images/17/09.png)
