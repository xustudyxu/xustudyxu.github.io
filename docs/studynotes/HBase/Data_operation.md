...
![01](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/HBase/images/05/01.png)
...
![02](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/HBase/images/05/02.png)

+ 描述:如果指定的单元格已经存在，则put操作为更新数据；
  + 单元格会保存指定VERSIONS=>n的多个版本数据

![03](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/HBase/images/05/03.png)
...
![04](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/HBase/images/05/04.png)
...
![05](https://fastly.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/HBase/images/05/05.png)
