...
date: 2022-07-09 19:51:42
permalink: /middleware/ElasticSearch/ElasticSearch_optimization
categories:
  - ElasticSearch
tags:
  - ElasticSearch
...
- 控制每个分片占用的硬盘容量不超过 ES 的最大 JVM 的堆空间设置（<mark>一般设置不超过 32G</mark>，参考下文的 JVM 设置原则），因此，如果索引的总容量在 500G 左右，那分片大小在 16 个左右即可；当然，最好同时考虑原则 2
