...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.2wldm940hu40.webp)

## include

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.62lr2dieq8g0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.dj0oyoiz5lc.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.12g81csqei5c.webp)

### timeout

一个空闲的客户端维持多少秒会关闭，0 表示关闭该功能。即永不关闭。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.6glvy8su6hk0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.6smxk5voaeg0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.58cxq6t657g0.webp)

### pidfile

存放 pid 文件的位置，每个实例会产生一个不同的 pid 文件

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.4r8ts2i60ce.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.5dr7ffokpp40.webp)

### logfile

日志文件名称

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.5rxjmoz5t5g0.webp)

### databases

设定库的数量 默认 16，默认数据库为 0，可以使用 `SELECT <dbid>`命令在连接上指定数据库 id。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.4yhdsttiv8k0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.1240hsnunjls.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.292e2mnfuyv4.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.4f1aycqioec0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.65bq1oeq7t80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.18vbghy9nohs.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.61m0c6j7l6g0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.4k9gvtjhemm0.webp)

## append only模式

AOF 相关部分

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.1n579oynzb28.webp)

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/image.4b9868dsuv20.webp)
