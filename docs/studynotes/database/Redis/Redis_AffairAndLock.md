...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.5c4bp1qu8z00.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.70upunii4zs0.webp)

+ 如果执行阶段(exec)某个命令报出了错误，则只有报错的命令不会被执行，而其他的命令都会执行，不会回滚

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.3ry9ng5dc660.webp)

### 案例图

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.6c5ajedxo0g0.webp)

手动回滚

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.4h76tcpvthu0.webp)

若在事务队列中存在命令性错误（类似于 java 编译性错误），则执行 EXEC 命令时，所有命令都不会执行

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.6pmk6x7zju.webp)

若在事务队列中存在语法性错误（类似于 java 的 1/0 的运行时异常），则执行 EXEC 命令时，其他正确命令会被执行，错误命令抛出异常。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.5f7ho05k7900.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.43ckflvmbhe0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220617/image.75iw7f6y5os0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220618/image.2wlkph5xpg80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220618/image.547yl8y5a880.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220618/image.6wfaz48644k0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220618/image.5jvgxjzwyu40.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting@master/20220618/image.48v2k228eg80.webp)
