...
![image-20211031230239760](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image-20211031230239760.4lltc4efppk0.webp)

3. 下载完成后，上传MySQL安装包

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.7b1siexp8yw0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.5trm4of7da80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.4ceabfxp7o20.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.2x5ygpv62bc0.webp)

如果主键是顺序插入的，则会形成一个单向链表，结构如下：

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.11jj75v1pmvk.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.3gnt45t33c80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.502an5672xg0.webp)

> 树的度数指的是一个节点的子节点个数。

我们可以通过一个数据结构可视化的网站来简单演示一下。[B-Tree Visualization (usfca.edu)](https://www.cs.usfca.edu/~galles/visualization/BTree.html)

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.3ejefb0tmlk0.webp)

插入一组数据： 100 65 169 368 900 556 780 35 215 1200 234 888 158 90 1000 88
120 268 250 。然后观察一些数据插入过程中，节点的变化情况。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.57f9fwicq8c0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.19jn04aoruqo.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.4sdwnp6ytp40.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.75isnx49mkw0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.4np8kvtyma00.webp)

如果两个(或多个)键值，映射到一个相同的槽位上，他们就产生了hash冲突（也称为hash碰撞），可以通过链表来解决。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220922/image.1emkfrpfv50.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.1gn1yrumngio.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.6wtz50o3aps0.webp)
...
>
> ![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.43mt337llam0.webp)
>
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.2c74rg41jaas.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.35xc5gst9wi0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.19b65pth8a00.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.6g270hk9wf80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.3ujwo1rofe60.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.5pxymt5v6bc0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.5d77uumxdec0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.6ilv4sirfj80.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.xt14skcxe7k.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.klqugp2zs1o.webp)

id是主键，是一个聚集索引。 name字段建立了普通索引，是一个二级索引（辅助索引）。

B. 执行SQL : select * from tb_user where id = 2;

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.1ltqq3m3ctds.webp)

根据id查询，直接走聚集索引查询，一次索引扫描，直接返回数据，性能高。

C. 执行SQL：selet id,name from tb_user where name = 'Arm';

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.1ghxn35m2hxc.webp)

虽然是根据name字段查询，查询二级索引，但是由于查询返回在字段为 id，name，在name的二级索引中，这两个值都是可以直接获取到的，因为覆盖索引，所以不需要回表查询，性能高。

D. 执行SQL：selet id,name,gender from tb_user where name = 'Arm';

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220924/image.4o7ct08gz180.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220925/image.6pmpxlo2yiw0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220925/image.137p0h70od40.webp)
