...
```java
DEBUG 02-17 16:00:23,474 Cache Hit Ratio [com.frx01.mybatis.dao.EmployeeMapper]: 0.0  (LoggingCache.java:62) 
DEBUG 02-17 16:00:23,486 ==>  Preparing: select id,last_name lastName,gender,email from tbl_employee where id=?   (BaseJdbcLogger.java:145) 
DEBUG 02-17 16:00:23,512 ==> Parameters: 1(Integer)  (BaseJdbcLogger.java:145) 
DEBUG 02-17 16:00:23,529 <==      Total: 1  (BaseJdbcLogger.java:145) 
DEBUG 02-17 16:00:23,530 Cache Hit Ratio [com.frx01.mybatis.dao.EmployeeMapper]: 0.0  (LoggingCache.java:62) 
Employee{id=1, lastName='admin', email='jerry@123.com', gender='0'}
Employee{id=1, lastName='admin', email='jerry@123.com', gender='0'}
true
...
![1645079894324](./images/04/01.png)

## 第三方缓存整合原理

![1645085244788](./images/04/02.png)
