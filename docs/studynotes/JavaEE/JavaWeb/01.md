...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/02.png)

+ 如何实现客户端与服务端不同版本的交互呢

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/03.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/01.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/04.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/05.png)

2. Post请求

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/06.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/07.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/19.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/08.png)

1. 下载解压Tomcat9
2. 解压后目录结构

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/09.png)

3. 启动 Tomcat (在 tomcat 的安装目录下的 bin 目录 使用命令行启动 tomcat)

   方式一:双击脚本文件启动

   ![10](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/10.png)

   方式二:使用脚本命令启动

   ![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/11.png)

4. 服务器启动成功

   ![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/12.png)
...
5.  打开浏览器，输入http://localhost:8080/ 访问
   ...
   ![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/13.png)

6. 调用 shutdown 命令关闭Tomcat服务器

### Tomcat目录结构

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/14.png)
...
![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/15.png)

2.  设置 Tomcat 的安装目录

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/16.png) 

3. 配置Tomcat服务器完成

![001](https://jsd.cdn.zzko.cn/gh/xustudyxu/image-hosting@master/studynotes/Servlet/images/01/17.png)
