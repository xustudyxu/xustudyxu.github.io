...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220831/image.4allg2qmxww0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220831/image.4jnpi8ows1o0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220831/image.79kbqiibjmw0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.7cs0ri0kbnk0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.2b5f51i7f5zw.webp)

```sql
SELECT * FROM t_storage;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20221012/image.5aeajach9ls0.webp)

```sql
SELECT * FROM t_account;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.4w72fi0pycg0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.3n1fd5325y00.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.41l96vouw1c0.webp)

```sql
SELECT * FROM t_storage;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.5vqwhtoqdnk0.webp)

```sql
SELECT * FROM t_account;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.1kn0bm8iik5c.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.2l5vnjjun1e.webp)

```sql
SELECT * FROM t_storage;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.qpf2wazr99c.webp)

```sql
SELECT * FROM t_account;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220901/image.706shnyil7g0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.5ruzgxtsx9k0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.1qtc9j1zh5og.webp)

```sql
SELECT * FROM t_storage;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.39kalvkrafu0.webp)

```sql
SELECT * FROM t_account;
```

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.5jemsfuxnww0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.4kucd3b8uhk0.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.3aepx5ztene0.webp)

- 二阶段提交

二阶段如果顺利提交的话，因为"业务SQL"在一阶段已经提交至数据库，所以Seata框架只需将一阶段保存的快照数据和行锁删掉，完成数据清理即可。

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.17voa04kq7ek.webp)
...
![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.5faqn74q58k0.webp)

补充

![image](https://cdn.jsdmirror.com//gh/xustudyxu/image-hosting1@master/20220902/image.4kxovt5nfhq0.webp)