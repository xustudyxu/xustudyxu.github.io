...
1. 右键项目，新建模块,finish
   ...
   ![1641625983696](./images/01/02.png)

2. 点击ProjectStructure,添加web.xml，设置web.xml路径

   ![1641627578986](./images/01/03.png)

注：由于 Maven 的传递性，我们不必将所有需要的包全部配置依赖，而是配置最顶端的依赖，其他靠传递性导入。

![1641629620543](./images/01/04.png)
...
![1642233908513](./images/01/05.png)

+ 点击跳转

![1642233956341](./images/01/06.png)
