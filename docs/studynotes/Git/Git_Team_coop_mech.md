...
![1643359505178](./images/05/03.png)

![1643359555260](./images/05/04.png)
...
![1643359876763](./images/05/05.png)
...
![1643359976404](./images/05/06.png)
...
![1643361121763](./images/05/07.png)
...
![1643361471858](./images/05/13.png)

![1643361482198](./images/05/14.png)
...
![1643362514532](./images/05/15.png)

2. 在东方不败的 GitHub 账号里的地址栏复制收到的链接，然后点击 Fork 将项目叉到自己的本地仓库。

![1643362535056](./images/05/16.png)

叉入中…

![1643362551693](./images/05/17.png)

叉成功后可以看到当前仓库信息。

![1643362569324](./images/05/18.png)

3. 东方不败就可以在线编辑叉取过来的文件。

![1643362593980](./images/05/19.png)

4. 编辑完毕后，填写描述信息并点击左下角绿色按钮提交。

![1643362616621](./images/05/20.png)

5. 接下来点击上方的 Pull 请求，并创建一个新的请求。

![1643362652786](./images/05/21.png)

![1643362669680](./images/05/22.png)

![1643362680859](./images/05/23.png)

6. 回到岳岳 GitHub 账号可以看到有一个 Pull request 请求。

![1643362697569](./images/05/24.png)

进入到聊天室，可以讨论代码相关内容。

![1643362745004](./images/05/25.png)

![1643362754254](./images/05/26.png)

7. 如果代码没有问题，可以点击 Merge pull reque 合并代码。

![1643362777009](./images/05/27.png)

## SSH 免密登录

我们可以看到远程仓库中还有一个 SSH 的地址，因此我们也可以使用 SSH 进行访问。

![1643362807862](./images/05/28.png)
...
![1643362906902](./images/05/29.png)

![1643362916523](./images/05/30.png)

![1643362928743](./images/05/31.png)
