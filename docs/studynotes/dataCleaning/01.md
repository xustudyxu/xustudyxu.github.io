...
![01](https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/dataCleaning/images/01/01.png)
...
![02](https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/dataCleaning/images/01/02.png)
...
![03](https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/dataCleaning/images/01/03.png)

按照之前的理论，如果以上数组按照`axis=0`的方式进行相加，得到的结果如下：
![04](https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/dataCleaning/images/01/04.png)
如果是按照`axis=1`的方式进行相加，得到的结果如下：
![05](https://cdn.jsdelivr.net/gh/xustudyxu/image-hosting@master/studynotes/dataCleaning/images/01/05.png)
